...
Console.prototype.addInspectedHeapObject = function () {
    var input = this._inspector._splitArgs(arguments);

    var paramObject = {
        'heapObjectId': input.args[0]
    };

    this._inspector._request('Console.addInspectedHeapObject', paramObject, input.callback);
};
