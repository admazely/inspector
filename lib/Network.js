...
//
Network.prototype.setUserAgentOverride = function () {
    var input = this._inspector._splitArgs(arguments);

    var paramObject = {
        'userAgent': input.args[0]
    };

    this._inspector._request('Network.setUserAgentOverride', paramObject, input.callback);
};
...
//
Network.prototype.replayXHR = function () {
    var input = this._inspector._splitArgs(arguments);
    ...
    this._inspector._request('Network.replayXHR', paramObject, input.callback);
};
