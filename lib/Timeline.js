...
Timeline.prototype.start = function () {
    ...
    var paramObject = {
        ...
        'includeDomCounters': input.args[1]
    };
...
//
// Tells whether timeline agent supports main thread CPU utilization 
// instrumentation. 
//
Timeline.prototype.canMonitorMainThread = function () {
    var input = this._inspector._splitArgs(arguments);

    var paramObject = {
    };

    this._inspector._request('Timeline.canMonitorMainThread', paramObject, input.callback);
};
